...
export const initialTasks: Map<string, Task> = new Map([
  ...
  ["m", { name: "M", duration: 30, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["g", "j", "l"] }],
  ...
  ["u", { name: "U", duration: 4, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["r", "t"] }],
  ["v", { name: "V", duration: 2, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["s", "t"] }],
  ["w", { name: "W", duration: 7, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["r", "s"] }]
]);
...
export const taskMap1: Map<string, Task> = new Map([
  ...
  ["G", { name: "G", duration: 24, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["C", "D"] }],
  ["H", { name: "H", duration: 20, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["E", "F", "G"] }],
  ["I", { name: "I", duration: 12, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["C", "D"] }],
  ["J", { name: "J", duration: 16, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["E", "F", "G"] }],
  ["K", { name: "K", duration: 32, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["I", "J", "H"] }],
  ["L", { name: "L", duration: 36, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["I", "J", "H"] }]
]);

export const taskMap2: Map<string, Task> = new Map([
  ['deb', { name: '', duration: 0, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: [] }],
  ["A", { name: "A", duration: 3, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["deb"] }],
  ["B", { name: "B", duration: 4, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["A", "I"] }],
  ...
  ["E", { name: "E", duration: 2, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["D", "H"] }],
  ["F", { name: "F", duration: 5, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["E", "I"] }],
  ...
  ["K", { name: "K", duration: 3, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["I", "J"] }],
  ...
  ["N", { name: "N", duration: 2, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["M", "T"] }],
  ["O", { name: "O", duration: 3, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["C", "F", "M"] }],
  ["P", { name: "P", duration: 3, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["N", "O"] }],
  ["Q", { name: "Q", duration: 2, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["P"] }],
  ["R", { name: "R", duration: 1, earlyDate: 0, lateDate: 0, nextTasks: [], prevTasks: ["K", "N", "O"] }],
